...
Paper-ready phrasings for §6.1. This file is an excerpt from the central `Results_Wording_Bank.md` (§1. Headline tracking); update only the central file.

## Drop-in wording

See `S06_01_Report.md` → *Manuscript-facing wording (drop-in)* block. The phrasings are reproduced from `Results_Wording_Bank.md` §1. Headline tracking.
