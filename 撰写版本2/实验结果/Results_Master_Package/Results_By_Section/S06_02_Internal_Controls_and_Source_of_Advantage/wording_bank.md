...
Paper-ready phrasings for §6.2. This file is an excerpt from the central `Results_Wording_Bank.md` (§2. Internal controls); update only the central file.

## Drop-in wording

See `S06_02_Report.md` → *Manuscript-facing wording (drop-in)* block. The phrasings are reproduced from `Results_Wording_Bank.md` §2. Internal controls.
