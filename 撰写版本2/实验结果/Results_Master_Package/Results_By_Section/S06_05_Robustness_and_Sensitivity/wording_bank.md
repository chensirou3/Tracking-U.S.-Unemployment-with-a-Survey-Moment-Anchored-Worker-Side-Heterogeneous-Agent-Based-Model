...
Paper-ready phrasings for §6.5. This file is an excerpt from the central `Results_Wording_Bank.md` (§5. Robustness); update only the central file.

## Drop-in wording

See `S06_05_Report.md` → *Manuscript-facing wording (drop-in)* block. The phrasings are reproduced from `Results_Wording_Bank.md` §5. Robustness.
